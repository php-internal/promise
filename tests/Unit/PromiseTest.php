...
use React\Promise\Tests\Unit\Fixture\SimpleFulfilledTestPromise;
use React\Promise\Tests\Unit\Fixture\SimpleRejectedTestPromise;
use React\Promise\Tests\Unit\PromiseAdapter\CallbackPromiseAdapter;

class PromiseTest extends TestCase
{
    use Unit\PromiseTest\FullTestTrait;
